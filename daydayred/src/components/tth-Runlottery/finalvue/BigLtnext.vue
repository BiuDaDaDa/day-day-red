  ...
  export default {
    ...
    methods: {
      testData () {
        this.$request({
          type: 'get',
          url: 'api/data/Handler.ashx?action=601&params={%22IssueID%22:460697}',
          headers: {},
          params: {},
          success: function (res) {
            ...
            this.WinNumber = Test.cutBiglt(this.ssq['WinNumber'])
...
<style scoped lang="less">
  ...
  .lottery-number strong:last-child,.lottery-number strong:nth-child(6) {
